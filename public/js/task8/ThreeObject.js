    ...
    render(shaderProgram, viewMatrix, projectionMatrix) {
        if (this.loaded) {
            ...
            if (this.bumpTexture) {
                ...
                shaderProgram.setUniform1i('uBumpTexture', 1);
                shaderProgram.setUniform1i('uUseBumpTexture', 1);
                if (this.bumpTextureSize) {
                    shaderProgram.setUniform2fv('uBumpTextureSize', this.bumpTextureSize);
                }
            }
